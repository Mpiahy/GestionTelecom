    ...
    <div class="container-fluid">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="row mt-2">
                    <div class="col">
                        <form action="search_user_login">
                            <div class="input-group"><span class="input-group-text">Chantier</span><input class="form-control" type="text" placeholder="Rechercher par Chantier" name="search_user_ue" /><button class="btn btn-primary" type="submit">Rechercher</button></div>
                        </form>
                    </div>
                    <div class="col">
                        <form action="search_user_login">
                            <div class="input-group"><span class="input-group-text">Login</span><input class="form-control" type="text" placeholder="Rechercher par Login" name="search_user_login" /><button class="btn btn-primary" type="submit">Rechercher</button></div>
                        </form>
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col">
                        <div class="btn-group" role="group"><button class="btn btn-outline-primary active" type="button" style="margin-right: 0px;">Tout</button><button class="btn btn-outline-primary" type="button">Collaborateur</button><button class="btn btn-outline-primary" type="button">Prestataire</button><button class="btn btn-outline-primary" type="button">Stagiaire</button></div>
                    </div>
                    <div class="col">
                        <form action="search_user">
                            <div class="input-group"><span class="input-group-text">Utilisateur</span><input class="form-control" type="text" placeholder="Rechercher un Utilisateur" name="search_user" /><button class="btn btn-primary" type="submit">Rechercher</button></div>
                        </form>
                    </div>
                </div>
                    ...
                    <table id="dataTable" class="table table-hover my-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>2200001AD001 - SERVICE INFO - 300800</td>
                                <td class="text-center"><a href="voir_emp" style="margin-right: 10px;" data-bs-target="#modal_voir_emp" data-bs-toggle="modal" data-toggle="tooltip" title="Voir"><i class="fas fa-history text-primary" style="font-size: 25px;"></i></a><a href="edit_emp" data-toggle="tooltip" title="Modifier"><i class="far fa-edit text-warning" style="font-size: 25px;"></i></a></td>
                            </tr>
                        </tbody>
                    </table>
